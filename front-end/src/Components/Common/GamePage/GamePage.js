...
class GamePage extends Component {
    ...
    onScoreRedirect = () => this.setState({ scoreRedirect: true })

    
    render() {

        if (this.state.scoreRedirect) 
            return (
                //  redirect to score page and set into Score's props gameName
                <Redirect push to={{
                    pathname: '/home/score',
                    state: {
                        gameName: this.props.component
                    }
                }} />
            )
        else 
